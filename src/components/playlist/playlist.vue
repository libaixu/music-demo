    ...
    <div class="playlist" v-show="showflag" @click="hide">
      <div class="list-wrapper" @click.stop>
        <div class="list-header">
          <h1 class="title">
            <i class="icon" :class="iconMode" @click="playModeChange"></i>
            <span class="text">{{modeText}}</span>
            <span class="clear" @click="showConfim"><i class="icon-clear"></i></span>
          </h1>
        </div>
      ...
      <confim @confim="clear" ref="confim" title="确认要清空播放列表？" confimBtn="清空"></confim>
...
<style lang="stylus" scoped rel="stylesheet/stylus">
  ...
  .playlist
    ...
    .list-wrapper
      ...
      bottom: 0
      width: 100%
      background-color: $color-heightLight-background
      .list-header
        position: relative
